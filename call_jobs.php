	...
	$file_code3 =  $_GET["file_code"];	
        ...
        if ($result_filecode) {
           ...
           // เจ้าหน้าที่ตัวอย่าง
            ...
            $exa_kratung_temp =  $row_filecode['exa_kratung'];
            ...
            // check ปะมือ ปะเครื่อง  ปั้มนูน  ปั้มขาด  / ปั้ม ไม่ปั้ม   / มี กระทุ้ง
               ...
               $pur_alu_check = "checked";
                ...
                if ($exa_kratung_temp  !="") {
                   $exa_kratung_pur = $exa_kratung_temp;
                   $exa_kratung_temp = "checked";
   ...
   switch ($exa_3front1_type) {
    ...
    case "อื่น ๆ":
        ...
        break;
            ...
            if($exa_3front1_type=="SPOT UV" || $exa_3front1_type=="อื่น ๆ"){
  ...
  switch ($exa_3front2_type) {
    ...
    case "อื่น ๆ":
        ...
        break;
            ...
            if($exa_3front2_type=="SPOT UV" || $exa_3front2_type=="อื่น ๆ"){
 ...
 switch ($exa_3front3_type) {
    ...
    case "อื่น ๆ":
        ...
        break;
            ...
            if($exa_3front3_type=="SPOT UV" || $exa_3front3_type=="อื่น ๆ"){
  ...
  switch ($exa_3front4_type) {
    ...
    case "อื่น ๆ":
        ...
        break;
            ...
            if($exa_3front4_type=="SPOT UV" || $exa_3front4_type=="อื่น ๆ"){
...
<th><input disabled name="pur_size_width_box2" id="pur_size_width_box2" style="width:80px; text-align: right;" type="text" class="form-control" placeholder="กว้าง" maxlength="3" style="text-align: right" value="<?php echo $pur_size_width; ?>" OnChange="JavaScript:chkNum2(this)" smk-text="กรุณากรอกความกว้าง" required></th>
<th>&nbsp; &nbsp;ยาว&nbsp;<font color="red">*</font></th>
<th><input disabled name="pur_size_length_box2" id="pur_size_length_box2" style="width:80px; text-align: right;" type="text" class="form-control" placeholder="ยาว" maxlength="3" style="text-align: right" value="<?php echo $pur_size_length; ?>" OnChange="JavaScript:chkNum2(this)" smk-text="กรุณากรอกความยาว" required></th>
<th>&nbsp; &nbsp;&nbsp; &nbsp;</th>
...
<th>&nbsp; &nbsp;&nbsp;<?php if($exa_kratung_pur!=''){ echo '['.$exa_kratung_pur.']'; } ?>&nbsp; </th>
<!--
...
<th>Size กระดาษ &nbsp; &nbsp;กว้าง&nbsp;<font color="red">*</font></th>
<th><input  name="pur_size_width_box" id="pur_size_width_box" style="width:100px; text-align: right;" type="text" class="form-control" placeholder="" maxlength="7"  value="<?php echo $pur_size_width; ?>" OnChange="JavaScript:chkNum2(this)"></th>
<th>&nbsp; &nbsp;ยาว&nbsp;<font color="red">*</font></th>
<th><input  name="pur_size_length_box" id="pur_size_length_box" style="width:100px; text-align: right;" type="text" class="form-control" placeholder="" maxlength="7"  value="<?php echo $pur_size_length; ?>" OnChange="JavaScript:chkNum2(this)"></th>
<th>&nbsp; &nbsp;&nbsp; &nbsp;</th>
<th>การเลย์&nbsp;<font color="red">*</font>&nbsp; &nbsp;</th>
...
<th>&nbsp; &nbsp;&nbsp; &nbsp;<input type="checkbox" name = "exa_check_kratung" id="exa_check_kratung" value="มี งานกระทุ้ง" <?php echo $exa_kratung_temp; ?> > มี งานกระทุ้ง</th>
				...
				var num = parseFloat(ele.value);
                                    if(isNaN(num)){  
                                        ele.value = '';
                                               ...
                                               if(num==0 || num>3){
                                                     alert('กรุณากรอกตัวเลข 1-3 เท่านั้น ');
                                                    ele.value = '';
                                               }else{
                                                   ele.value = num;
                                               }
				...
				var num = parseFloat(ele.value);
                                    if(isNaN(num)){  
                                        ele.value = '';
                                               ...
                                               if(num==0 || num>6){
                                                     alert('กรุณากรอกตัวเลข 1-6 เท่านั้น ');
                                                    ele.value = '';
                                               }else{
                                                   ele.value = num;
                                               }
