...
<!-- แก้ -->
 ...
 <p></p>
                        ...
                        <th> <input name="pur_frontType1_box" id="pur_frontType1_box" type="text" class="form-control"  style="width:120px;"  value="<?php echo $exa_3front1_type; ?>" readonly></th>
                                 ...
                                 <th>&nbsp;&nbsp;&nbsp;&nbsp;ราคา</th>
                        <th> <input <?php echo $dis_price_front_box1; ?> name="pur_frontType1_price_box" id="pur_frontType1_price_box" type="text" class="form-control"  style="width:120px; text-align: right;"  value="<?php echo $exa_3front1_price; ?>" OnChange="JavaScript:chkNum_addcomma2(this)"></th>
                        ...
                        <th> <input name="pur_frontType2_box" id="pur_frontType2_box" type="text" class="form-control"  style="width:120px;"  value="<?php echo $exa_3front2_type; ?>" readonly></th>
                                  ...
                                  <th>&nbsp;&nbsp;&nbsp;&nbsp;ราคา</th>
                        <th> <input <?php echo $dis_price_front_box2; ?> name="pur_frontType2_price_box" id="pur_frontType2_price_box" type="text" class="form-control"  style="width:120px; text-align: right;"  value="<?php echo $exa_3front2_price; ?>" OnChange="JavaScript:chkNum_addcomma2(this)"></th>
                        ...
                        <th> <input name="pur_frontType3_box" id="pur_frontType3_box" type="text" class="form-control"  style="width:120px;"  value="<?php echo $exa_3front3_type; ?>" readonly></th>
                                 ...
                                 <th>&nbsp;&nbsp;&nbsp;&nbsp;ราคา</th>
                        <th> <input <?php echo $dis_price_front_box2; ?> name="pur_frontType3_price_box" id="pur_frontType3_price_box" type="text" class="form-control"  style="width:120px; text-align: right;"  value="<?php echo $exa_3front3_price; ?>" OnChange="JavaScript:chkNum_addcomma2(this)"></th>
                        ...
                        <th> <input name="pur_frontType4_box" id="pur_frontType4_box" type="text" class="form-control"  style="width:120px;"  value="<?php echo $exa_3front4_type; ?>" readonly></th>
                                  ...
                                  <th>&nbsp;&nbsp;&nbsp;&nbsp;ราคา</th>
                        <th> <input <?php echo $dis_price_front_box4; ?> name="pur_frontType4_price_box" id="pur_frontType4_price_box" type="text" class="form-control"  style="width:120px; text-align: right;"  value="<?php echo $exa_3front4_price; ?>" OnChange="JavaScript:chkNum_addcomma2(this)"></th>
...
<th>&nbsp;  ชั้น</th>
<th>&nbsp; &nbsp; ชนิดของลูกฟูก&nbsp;</th>
<th><input disabled type="text" class="form-control" style="width:60px; text-align: right;" id="pur_4LF_type_box" name="pur_4LF_type_box" placeholder="" value="<?php echo $sales_4LF_type; ?>"  ></th>
...
<th>&nbsp; &nbsp;&nbsp;ราคา</th>
<th><input <?php echo $dis_price_front_box1; ?> type="text" class="form-control" style="width:80px; text-align: right;" id="exa_3front1_price_box" name="exa_3front1_price_box" placeholder="" maxlength="6" value="<?php echo $exa_3front1_price; ?>"  OnChange="JavaScript:chkNum_addcomma2(this)"  </th>
...
<th>&nbsp; &nbsp;&nbsp;ราคา</th>
<th><input type="text" class="form-control" style="width:80px; text-align: right;" id="exa_3front2_price_box" name="exa_3front2_price_box" placeholder=""  maxlength="6" value="<?php echo $exa_3front2_price; ?>" OnChange="JavaScript:chkNum_addcomma2(this)" <?php echo $dis_price_front_box2; ?>></th>
...
<th>&nbsp; &nbsp;&nbsp;ราคา</th>
<th><input type="text" class="form-control" style="width:80px; text-align: right;" id="exa_3front3_price_box" name="exa_3front3_price_box" placeholder=""  maxlength="6" value="<?php echo $exa_3front3_price; ?>" OnChange="JavaScript:chkNum_addcomma2(this)" <?php echo $dis_price_front_box3; ?>></th>
...
<th>&nbsp; &nbsp;&nbsp;ราคา</th>
<th><input type="text" class="form-control" style="width:80px; text-align: right;" id="exa_3front4_price_box" name="exa_3front4_price_box" placeholder=""  maxlength="6" value="<?php echo $exa_3front4_price; ?>" OnChange="JavaScript:chkNum_addcomma2(this)" <?php echo $dis_price_front_box4; ?>></th>
 ...
 <!-- REQUIRED JS SCRIPTS -->
    ...
    <script>
        ...
        var element1 = document.getElementById('drop3_1').value;
             if (element1=='SPORT UV' || element1=='อื่น ๆ' ){
    ...
    <script>
         function run_drop312() {
             var element2 = document.getElementById('drop3_2').value;
             if (element2=='SPORT UV' || element2=='อื่น ๆ' ){
    ...
    <script>
         function run_drop313() {
             var element3 = document.getElementById('drop3_3').value;
             if (element3=='SPORT UV' || element3=='อื่น ๆ' ){
    ...
    <script>
         function run_drop314() {
             var element4 = document.getElementById('drop3_4').value;
             if (element4=='SPORT UV' || element4=='อื่น ๆ' ){
