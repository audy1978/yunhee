		...
		return false;
         ...
         <input type="text" class="form-control" style="width:100px;" id="pur_cat_box" value="<?php echo $pur_cat; ?>" placeholder="" >
               ...
               <input type="text" class="form-control" style="width:150px;" id="pur_seller_box" value="<?php echo $pur_seller; ?>" placeholder="" OnChange="JavaScript:chkNum(this)" >
                    ...
                    <div class="col-xs-1">
                        <label>ความหนา</label>
                        <input type="text" class="form-control" style="width:100px; text-align: right;" name="pur_thick_box" id="pur_thick_box" value="<?php echo $pur_thick; ?>" placeholder="" OnChange="JavaScript:chkNum(this)" >
                    </div>
...
<th></th>
<th>&nbsp; &nbsp;ความหนา</th>
<th><input name="exa_plastic_thick_box_gram" id="exa_plastic_thick_box_gram" style="width:100px; text-align: right;" type="text" class="form-control" style="text-align: right" value="<?php echo $pur_thick_gram; ?>" maxlength="3"  OnChange="JavaScript:chkNum_z(this)"></th>
<th>แกรม &nbsp; &nbsp;Size กระดาษ &nbsp; &nbsp;กว้าง</th>
<th><input name="exa_plastic_width_box" id="exa_plastic_width_box" style="width:60px; text-align: right;" type="text" class="form-control" placeholder="" maxlength="3" style="text-align: right" value="<?php echo $pur_size_width; ?>" ></th>
<th>&nbsp; &nbsp;ยาว</th>
<th><input name="exa_plastic_length_box" id="exa_plastic_length_box" style="width:60px; text-align: right;" type="text" class="form-control" placeholder="" maxlength="3" style="text-align: right" value="<?php echo $pur_size_length; ?>" ></th>
<th>&nbsp; &nbsp;&nbsp; &nbsp;</th>
<th>การเลย์&nbsp; &nbsp;</th>
...
<th><input type="text" class="form-control" style="width:50px; text-align: right;" id="exa_printAmont_box" name="exa_printAmont_box" value="<?php echo $exa_printAmont; ?>" placeholder="" OnChange="JavaScript:chkNum(this)" ></th>
<th>&nbsp; &nbsp;&nbsp; &nbsp;</th>
<th>สี&nbsp; &nbsp;</th>
...
<tr>
    <th>&nbsp; &nbsp;&nbsp; &nbsp;พลาสติก&nbsp; &nbsp;&nbsp; &nbsp;</th>
<th>กว้าง&nbsp; </th>
<th><input type="text" class="form-control" style="width:80px; text-align: right;" id="exa_plastic_width_box2" value="<?php echo $pur_plastic_width; ?>" placeholder="" OnChange="JavaScript:chkNum(this)"></th>
<th>&nbsp; &nbsp;&nbsp; &nbsp;ยาว&nbsp; </th>
<th><input type="text" class="form-control" style="width:80px; text-align: right;" id="exa_plastic_length_box2" value="<?php echo $pur_plastic_length; ?>" placeholder="" OnChange="JavaScript:chkNum(this)"></th>
<th>&nbsp; &nbsp;&nbsp; &nbsp;หนา&nbsp;</th>

<th><input type="text" class="form-control" style="width:80px; text-align: right;" id="exa_plastic_thick_box" value="<?php echo $pur_plastic_thick; ?>" placeholder="" OnChange="JavaScript:chkNum(this)"></th>
<th>&nbsp; &nbsp;&nbsp; &nbsp;บริษัท&nbsp;</th>
<th><input type="text" class="form-control" style="width:150px;" id="exa_company_box" value="<?php echo $pur_company; ?>" placeholder="" OnChange="JavaScript:chkNum(this)"></th>
...
<tr>
 ...
 <th> 8. ค่าขนส่ง</th>
 <th>&nbsp;&nbsp;<input id ="check_logis_factor1" name ="check_logis_factor" type="radio" value="500" <?php echo $man_check_logis1; ?>>  500 </th>
...
<th><input type="text" class="form-control" style="width:100px; text-align: right; background: #4FFF7E" id="man_Kratung_price_box2" name="man_Kratung_price_box2" placeholder="" value="<?php if($exa_kratung!=''){echo number_format((($pur_lay3*100)+1000),3);}else{echo '';} ?>" OnChange="JavaScript:chkNum3(this)"></th>
       ...
       <!-- ปั้มนูน 3 รอบในการคำนวณ  -->
         <p>
                      ...
                      <div class = "row">
                        ...
                        <th>&nbsp;รอบ1 ก.</th>
                        <th><input disabled  id="R1_width" name="R1_width" type="text" class="form-control" style="width:60px; text-align: right;"  value="<?php echo number_format($exa_PN_R1A,2); ?>" placeholder="" ></th>
                        <th>&nbsp;&nbsp;ย.</th>
                        <th><input disabled id="R1_lenght" name="R1_lenght" type="text" class="form-control" style="width:60px; text-align: right;"  value="<?php echo number_format($exa_PN_R1Y,2); ?>" placeholder="" ></th>
                        ...
                        <th>&nbsp;&nbsp;&nbsp;&nbsp;</th>
                        <th>รอบ2 ก.</th>
                        <th><input disabled id="R2_width" name="R2_width" type="text" class="form-control" style="width:60px; text-align: right;"  value="<?php echo number_format($exa_PN_R2A,2); ?>" placeholder="" ></th>
                        <th>&nbsp;&nbsp;ย.</th>
                        <th><input disabled id="R2_lenght" name="R2_lenght" type="text" class="form-control" style="width:60px; text-align: right;"  value="<?php echo number_format($exa_PN_R2Y,2); ?>" placeholder="" ></th>
                        ...
                        <th> </th>
                        <th>รอบ3 ก.</td>
                        <th><input disabled id="R3_width" name="R3_width" type="text" class="form-control" style="width:60px; text-align: right;"  value="<?php echo number_format($exa_PN_R3A,2); ?>" placeholder="" ></th>
                        <th>&nbsp;&nbsp;ย.</td>
                        <th><input disabled id="R3_lenght" name="R3_lenght" type="text" class="form-control" style="width:60px; text-align: right;"  value="<?php echo number_format($exa_PN_R3Y,2); ?>" placeholder="" ></th>
      ...
      <tr>
       ...
       <td><input  type="text" name="calc_wage1" id="calc_wage1" value="<?php echo $wage1_value; ?>" style="width:80px; text-align: right; background-color: #F5F5F5; border: 0px;"></td>
        ...
        <td><input  type="text" name="calc_Diecut1" id="calc_Diecut1" value="<?php echo $Diecut1_value; ?>" style="width:80px; text-align: right; background-color: #F5F5F5; border: 0px;"></td>
         ...
         <td><input  type="text" name="calc_plate1" id="calc_plate1" value="<?php echo $plate1_value; ?>" style="width:80px; text-align: right; background-color: #F5F5F5; border: 0px;"></td>
       ...
       <td><input  type="text" name="calc_wage2" id="calc_wage2" value="<?php echo $wage2_value; ?>" style="width:80px; text-align: right; background-color: #F5F5F5; border: 0px;"></td>
         ...
         <td><input  type="text" name="calc_plate2" id="calc_plate2" value="<?php echo $plate2_value; ?>" style="width:80px; text-align: right; background-color: #F5F5F5; border: 0px;"></td>
       ...
       <td><input  type="text" name="calc_wage3" id="calc_wage3" value="<?php echo $wage3_value; ?>" style="width:80px; text-align: right; background-color: #F5F5F5; border: 0px;"></td>
        ...
        <td><input  type="text" name="calc_Diecut3" id="calc_Diecut3" value="<?php echo $Diecut3_value; ?>" style="width:80px; text-align: right; background-color: #F5F5F5; border: 0px;"></td>
         ...
         <td><input  type="text" name="calc_plate3" id="calc_plate3" value="<?php echo $plate3_value; ?>" style="width:80px; text-align: right; background-color: #F5F5F5; border: 0px;"></td>
        ...
        <td><input  type="text" name="calc_Diecut4" id="calc_Diecut4" value="<?php echo $Diecut4_value; ?>" style="width:80px; text-align: right; background-color: #F5F5F5; border: 0px;"></td>
         ...
         <td><input  type="text" name="calc_plate4" id="calc_plate4" value="<?php echo $plate4_value; ?>" style="width:80px; text-align: right; background-color: #F5F5F5; border: 0px;"></td>
        ...
        <td><input  type="text" name="calc_plate5" id="calc_plate5" value="<?php echo $plate5_value; ?>" style="width:80px; text-align: right; background-color: #F5F5F5; border: 0px;"></td>
        ...
        <td><input  type="text" name="calc_plate6" id="calc_plate6" value="<?php echo $plate6_value; ?>" style="width:80px; text-align: right; background-color: #F5F5F5; border: 0px;"></td>
    ...
    <script>
                        ...
                        document.getElementById('bt_calc_front').onclick= function() {
                           ...
                           if (ch_wage11.checked) {
                                ...
                                ch_wage = ch_wage44.value;
                                  ...
                                  if (type1.value=="อื่น ๆ" || type1.value=="SPORT UV" || type1.value=="-"){
                                   
                                    result_type1 = <?php echo $exa_3front1_price; ?>;
                                   
                                      
                                    } else if(type1.value=="อาบเงา")  {
                                      result_type1 = exa_plastic_width.value*exa_plastic_length.value*ch_wage;
                                      
                                   } else if(type1.value=="อาบด้าน")  {
                                      result_type1 = exa_plastic_width.value*exa_plastic_length.value*ch_wage;
                                      
                                    }else if(type1.value=='ขัดเงา เว้นลิ้น'){
                                    result_type1 = ((exa_3front1_width.value*exa_3front1_lenght.value*0.0013)/value_Z.value);
                                   
                                  
                                   }else if(type1.value=='UV เว้นลิ้น'){
                                    result_type1 = ((parseFloat(exa_3front1_width.value)*parseFloat(exa_3front1_lenght.value)*0.0012)/value_Z.value);
                                   
                                 
                                   }else if(type1.value=='OPP เงา'){
                                    result_type1 = ((exa_3front1_width.value*exa_3front1_lenght.value*0.0030)/value_Z.value);
                                   
                                  
                                   }else if(type1.value=='OOP ด้าน'){
                                    result_type1 = ((exa_3front1_width.value*exa_3front1_lenght.value*0.0040)/value_Z.value);
                                   
                                      }
                                     
                                 
                                 
                                 if (type2.value=="อื่น ๆ" || type2.value=="SPORT UV" || type2.value=="-"){
                                   
                                    result_type2 = <?php echo $exa_3front2_price; ?>;
                                   
                                
                                 
                                  } else if(type2.value=="อาบเงา")  {
                                      result_type2 = exa_plastic_width.value*exa_plastic_length.value*ch_wage;
                                      
                                   } else if(type2.value=="อาบด้าน")  {
                                      result_type2 = exa_plastic_width.value*exa_plastic_length.value*ch_wage;
                                      
                                    }else if(type2.value=='ขัดเงา เว้นลิ้น'){
                                    result_type2 = ((exa_3front2_width.value*exa_3front2_lenght.value*0.0013)/value_Z.value);
                                   
                                  
                                   }else if(type2.value=='UV เว้นลิ้น'){
                                    result_type2 = ((exa_3front2_width.value*exa_3front2_lenght.value*0.0012)/value_Z.value);
                                   
                                 
                                   }else if(type2.value=='OPP เงา'){
                                    result_type2 = ((exa_3front2_width.value*exa_3front2_lenght.value*0.0030)/value_Z.value);
                                   
                                  
                                   }else if(type2.value=='OOP ด้าน'){
                                    result_type2 = ((exa_3front2_width.value*exa_3front2_lenght.value*0.0040)/value_Z.value);
                                   
                                      }
                                     
                                 
                               
                                     if (type3.value=="อื่น ๆ" || type3.value=="SPORT UV" || type3.value=="-"){
                                   
                                    result_type3 = <?php echo $exa_3front3_price; ?>;
                                   
                                
                                 
                                  } else if(type3.value=="อาบเงา")  {
                                      result_type3 = exa_plastic_width.value*exa_plastic_length.value*ch_wage;
                                      
                                   } else if(type3.value=="อาบด้าน")  {
                                      result_type3 = exa_plastic_width.value*exa_plastic_length.value*ch_wage;
                                      
                                    }else if(type3.value=='ขัดเงา เว้นลิ้น'){
                                    result_type3 = ((exa_3front3_width.value*exa_3front3_lenght.value*0.0013)/value_Z.value);
                                   
                                  
                                   }else if(type3.value=='UV เว้นลิ้น'){
                                    result_type3 = ((exa_3front3_width.value*exa_3front3_lenght.value*0.0012)/value_Z.value);
                                   
                                 
                                   }else if(type3.value=='OPP เงา'){
                                    result_type3 = ((exa_3front3_width.value*exa_3front3_lenght.value*0.0030)/value_Z.value);
                                   
                                  
                                   }else if(type3.value=='OOP ด้าน'){
                                    result_type3 = ((exa_3front3_width.value*exa_3front3_lenght.value*0.0040)/value_Z.value);
                                   
                                      }
                                     
                                 
                         
                           if (type4.value=="อื่น ๆ" || type4.value=="SPORT UV" || type4.value=="-"){
                                   
                                    result_type4 = <?php echo $exa_3front4_price; ?>;
                                   
                                
                                 
                                  } else if(type4.value=="อาบเงา")  {
                                      result_type4 = exa_plastic_width.value*exa_plastic_length.value*ch_wage;
                                      
                                   } else if(type4.value=="อาบด้าน")  {
                                      result_type4 = exa_plastic_width.value*exa_plastic_length.value*ch_wage;
                                      
                                    }else if(type4.value=='ขัดเงา เว้นลิ้น'){
                                    result_type4 = ((exa_3front4_width.value*exa_3front4_lenght.value*0.0013)/value_Z.value);
                                   
                                  
                                   }else if(type4.value=='UV เว้นลิ้น'){
                                    result_type4 = ((exa_3front4_width.value*exa_3front4_lenght.value*0.0012)/value_Z.value);
                                   
                                 
                                   }else if(type4.value=='OPP เงา'){
                                    result_type4 = ((exa_3front4_width.value*exa_3front4_lenght.value*0.0030)/value_Z.value);
                                   
                                  
                                   }else if(type4.value=='OOP ด้าน'){
                                    result_type4 = ((exa_3front4_width.value*exa_3front4_lenght.value*0.0040)/value_Z.value);
                       ...
                       document.getElementById('price_front4R').value = result_type4;
                        ...
                        document.getElementById('bt_calc_lf').onclick= function() {
                           ...
                           result_lf_price = (((lf_width.value*lf_length.value)/144)*factor_lf.value)/value_Z.value;
    
                              result_lf_price =  result_lf_price.toFixed(2);  
                           document.getElementById('lf_price_box').value = result_lf_price;
                           document.getElementById('lf_price_box2').value = result_lf_price;
                          
        
        
                           result_lami_price = (((lf_width.value*lf_length.value)/144)*lm_fac)/value_Z.value;
                                
                                result_lami_price =  result_lami_price.toFixed(2); 
               ...
               <script>
                        ...
                        document.getElementById('bt_calc_B_lf').onclick= function() {
                          ...
                          //  result_blf_price = 0;
                              ...
                              result_blf_price =  result_blf_price.toFixed(2);  
                 ...
                 <!--   คำนวนข้อ 5. Factor  -->                      
                        ...
                        ch_wage = ch_wage44.value;
                           ...
                           // คำนวณ ปั้มนูน
                                   ...
                                   result_price_pn1 = exa_plastic_width.value*exa_plastic_length.value*ch_wage*PN_amount.value;
                       ...
                       result_priee_py = exa_plastic_width.value*exa_plastic_length.value*ch_wage*PY_amount;
                       ...
                       result_price_kratung = exa_plastic_width.value*exa_plastic_length.value*ch_wage;
                       ...
                       document.getElementById('man_kratung_Wprice_box').value = '';
                       }
         ...
         <script>
                        ...
                        document.getElementById('bt_calc_logis').onclick= function() {
                          ...
                          //  var order1 = document.getElementById('order1_box');
                           ...
                           var logis_factor1 =document.getElementById('check_logis_factor1');
                           ...
                           var logis_factor5 =document.getElementById('check_logis_factor5');
                              ...
                              if (logis_factor1.checked) {
                                       logis_fac = logis_factor1.value;
                                } else if (logis_factor2.checked) {
