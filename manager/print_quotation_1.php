            ...
            <div class="row">
                <div class="col-md-12" style="padding: 50px;">
                  ...
                  <!-- <label><?php echo $qouta_customer; ?> </label>  -->
                    ...
                    <label> <font style="font-size: 14pt;">บริษัทฯ ขอเสนอราคาค่าผลิต <b><?php echo $jobs_file; ?></b> </font></label>
                        ...
                        <table data-toggle="table" data-striped="true">
                                <thead>
                                        <tr>
                                            <td style="font-size: 14pt;">วัสดุ กระดาษ </td>
                                            <th style="font-size: 14pt;"> <?php echo $qouta_paperMatt; ?> </th>
                                            
                                            <td style="font-size: 14pt;">   </td>
                                            <th style="font-size: 14pt;"><?php echo $pur_thick_gram; ?></th>
                                            
                                             <td style="font-size: 14pt;"> แกรม  </td>
                                        </tr>
                      ...
                      <table data-toggle="table" data-striped="true">
                                <thead>
                                        <tr>
                                            <td style="font-size: 14pt;">พิมพ์ </td>
                                            <th style="font-size: 14pt;"> <?php echo $exa_printAmont; ?></th>
                                            
                                            <td style="font-size: 14pt;">  สี   </td>
                                            <th style="font-size: 14pt;"><?php echo $qouta_color; ?></th>
