                     ...
                     <td>
                      ...
                      <td><span class="label label-warning">
                        ...
                        <?php
                           ...
                           ?>
                            <td><a href="edit_data_job.php?id_edit=<?php echo  $row[0]; ?>"  class="btn btn-success btn btn-default" role="button"> <span class="glyphicon glyphicon-pencil"></span> แก้ไข</a></td>
                          
                            <?php }else{ ?>    
                            <td><a href="call_jobs.php?file_code=<?php echo $row[7];; ?>&jobs_customer2=<?php echo $row[4]; ?>&jobs_file2=<?php echo $row[6]; ?> "  class="btn btn-success btn btn-default" role="button"> <span class="glyphicon glyphicon-pencil"></span> แก้ไขแฟ้มงาน</a></td>
