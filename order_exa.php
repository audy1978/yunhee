                                            ...
                                            <tr >
                                                <td style="text-align: left">ลูกค้า : <b><?php echo $jobs_customer; ?></b> </td>
                                                  ...
                                                  <tr >
                                                      ...
                                                      <td style="text-align: left" colspan="3">รหัสสินค้า :&nbsp;&nbsp;<input type="text" name="product_code" id="product_code" value="<?php echo $file_code3; ?>"> &nbsp;&nbsp;ชื่อสินค้า :&nbsp;&nbsp;<input type="text" name="product_name" id="product_name" style="width: 500px;" value="<?php echo $jobs_file; ?>"></td>
                                                 ...
                                                 <tr >
                                                 <td style="text-align: left" colspan="3">เลขที่ :&nbsp;&nbsp;<input type="text" name="customer_no" id="customer_no" value="<?php echo $customer_no; ?>">&nbsp;&nbsp;วันที่กำหนดส่ง : &nbsp;&nbsp;<input type="text" name="date_due" id="date_due" value="<?php echo $date_due; ?>"></td>
                       ...
                       <div class="row">
                                 <table class="table table-no-bordered">
                                        <thead>
                                           ...
                                           <tr>
                                               <td style="text-align: left" colspan="5">การบรรจุ&nbsp;&nbsp; &nbsp;&nbsp;<input type="radio" name="ck_hor_box" id="ck_hor" value="ห่อ" <?php echo $ck_hor_temp; ?>> ห่อ&nbsp;&nbsp; &nbsp;&nbsp;<input type="radio" name="ck_hor_box" id="ck_box" value="กล่อง" <?php echo $ck_box_temp; ?>> กล่อง &nbsp;&nbsp; &nbsp;&nbsp;<input type="checkbox" name="ck_pallet" id="ck_pallet" value="พาเลท" <?php echo $ck_pallet_temp; ?>> พาเลท</td>
                                           </tr>
