                    ...
                    <div class="col-md-6">
                        <form id="form1" action="insert_cust.php" method="post" class="form" novalidate>
                            <div class="form-group">
                                ...
                                <input id="custName" type="text" class="form-control" name="custName" smk-text="กรุณากรอกชื่อ-สกุล" required>
                            </div>
                            <div class="form-group">
                                <label for="custAddr">ที่อยู่</label>
                                <textarea id="custAddr" name="custAddr" class="form-control" rows="4"></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="custTel">โทรศัพท์</label>
