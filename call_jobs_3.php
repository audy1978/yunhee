...
<th>Size กระดาษ &nbsp; &nbsp;กว้าง&nbsp;<font color="red">*</font></th>
<th><input  name="pur_size_width_box" id="pur_size_width_box" style="width:100px; text-align: right;" type="text" class="form-control" placeholder="" maxlength="8"  value="<?php echo $pur_size_width; ?>" OnChange="JavaScript:chkNum2(this)"></th>
<th>&nbsp; &nbsp;ยาว&nbsp;<font color="red">*</font></th>
<th><input  name="pur_size_length_box" id="pur_size_length_box" style="width:100px; text-align: right;" type="text" class="form-control" placeholder="" maxlength="8"  value="<?php echo $pur_size_length; ?>" OnChange="JavaScript:chkNum2(this)"></th>
<th>&nbsp; &nbsp;&nbsp; &nbsp;</th>
<th>การเลย์&nbsp;<font color="red">*</font>&nbsp; &nbsp;</th>
